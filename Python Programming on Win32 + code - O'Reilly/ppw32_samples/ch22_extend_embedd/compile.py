...
!MESSAGE 
!MESSAGE "%(projectname)s - Win32 Release" (based on%(vc_longlinesep)s "Win32 (x86) Dynamic-Link Library")
!MESSAGE 

# Begin Project%(vc_extraprops)s
...
class Msdev:
    def __init__(self):
        ...
        if app is not None:
          ...
          print "Either MSDev or the COM extensions do not appear to be installed."
          print "A Visual C++ 5.0 workspace will be generated, and must be built manually."
        if version == "6.0":
    ...
    def build(self, workspace):
        ...
        try:
            ...
            configname = "Release"
            config = self.app.Projects(projectname).Configurations(projectname + " - Win32 " + configname)
...
class Project:
    ...
    def __init__(self, ws, msdev, line, extra_stuff):
        ...
        project_file_text = project_template % template_dict
