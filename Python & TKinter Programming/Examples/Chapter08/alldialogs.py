...
if __name__ == "__main__":
    ...
    print "info", showinfo("Trees", "#10, The Larch")
    print "warning", showwarning("Attention!", "Twit of the year approaching")
    print "error", showerror("Spam", "I don't like Spam")
    print "proceed", askokcancel("Cheese Shop", "Do you want Tilsit?")
    print "yes/no", askyesno("Self Defense", "Do you know Llap-Goch?")
    print "try again", askretrycancel("Problem", "This twit appears to be dead.\nWhat shall we do?")
