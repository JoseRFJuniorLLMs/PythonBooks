...
######################################################################
   	self.root = Tk()
        ...
        self.base = 'gray60'
        self.root['background'] = self.base
        self.set_colors()

        self.root.option_add('*background',           self.base)
        self.root.option_add('*foreground',           'black')
        self.root.option_add('*Frame*background',     self.lbase)
        self.root.option_add('*Label*background',     self.lbase)
        self.root.option_add('*Label*bordercolor',    self.lbase)
        self.root.option_add('*Canvas*ackground',     self.lbase)        
        self.root.option_add('*Label*borderwidth',    0)        
        self.root.option_add('*Label*highlightcolor',    self.lbase)                
        self.root.option_add('*Entry*background',     self.vlbase)
        self.root.option_add('*Entry*foreground',     'black')
        self.root.option_add('*Scrollbar*ackground',     self.lbase)        
#        self.root.option_add('*font',   ('arial', 12, 'bold'))
        self.root.option_add('*font',   ('verdana', 10))
        
        self.f1=Frame(self.root, borderwidth=1, relief=GROOVE, bg=self.lbase)
   	...
   	Pmw.EntryField(self.frx, value='John', entry_width=12).pack(side=LEFT, expand=NO, fill=BOTH)
        ...
        self.f2=Frame(self.root, borderwidth=1, relief=GROOVE, bg=self.lbase)
	...
	self.combobox.selectitem(positions[10])
        ...
        self.f3=Frame(self.root, borderwidth=1, relief=GROOVE, bg=self.lbase)
        ...
        self.f7=Frame(self.root, borderwidth=1, bg=self.base)
