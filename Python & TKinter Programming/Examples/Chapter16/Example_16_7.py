...
######################################################################
   	self.root = Tk()
        self.root.title('GUI Design 7')
        self.root.tk_setPalette("tan4")
        self.root.option_add('*background',           'tan4')
        self.root.option_add('*foreground',           'peachpuff')
        self.root.option_add('*Entry*background',     'wheat4')
        self.root.option_add('*Entry*foreground',     'wheat3')
