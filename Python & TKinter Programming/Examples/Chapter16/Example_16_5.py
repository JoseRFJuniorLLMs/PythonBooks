...
######################################################################
	...
	self.combobox.selectitem(positions[10])
        ...
        self.f4.pack(side=TOP, expand=YES, fill=BOTH, padx=8, pady=3)
        ...
        self.f5.pack(side=TOP, expand=YES, fill=BOTH, padx=8, pady=3)
        ...
        self.f6.pack(side=TOP, expand=YES, fill=BOTH, padx=8, pady=3)
        self.f3.pack(side=TOP, expand=YES, fill=BOTH, padx=8, pady=3)
