...
######################################################################
	...
	self.combobox.selectitem(positions[10])
        ...
        Pmw.EntryField(self.frd, value='(401) 555-1212',entry_width=14).pack(side=LEFT, expand=NO, fill=BOTH)
        Pmw.EntryField(self.frd, value='123-45-6789', entry_width=11).pack(side=RIGHT, expand=NO, fill=BOTH)
